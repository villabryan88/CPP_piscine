...
/*   Updated: 2019/05/03 02:52:25 by bvilla           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
	...
	std::cout << std::endl << std::endl << "Goku TIME!!!!" << std::endl << std::endl;
	
	std::cout << "Hit points : " << goku.getHitPoints() << std::endl;
	std::cout << "Max hit points : " << goku.getMaxHitPoints() << std::endl;
	std::cout << "Energy points : " << goku.getEnergyPoints() << std::endl;
	std::cout << "Max energy points : " << goku.getMaxEnergyPoints() << std::endl;
	std::cout << "Level : " << goku.getLevel() << std::endl;
	std::cout << "Name : " << goku.getName() << std::endl;
	std::cout << "Melee attack damage : " << goku.getMeleeAttackDamage() << std::endl;
	std::cout << "Ranged attack damage : " << goku.getRangedAttackDamage() << std::endl;
	std::cout << "Armor damage reduction: " << goku.getArmorDamageReduction() << std::endl;
	
	goku.rangedAttack("you");
	goku.meleeAttack("you");

	goku.ninjaShoebox(sasuke);
	goku.ninjaShoebox(jim);	
	goku.ninjaShoebox(bob);
	goku.vaulthunter_dot_exe("you");
	goku.vaulthunter_dot_exe("you");
	goku.vaulthunter_dot_exe("you");
	goku.vaulthunter_dot_exe("you");
	goku.vaulthunter_dot_exe("you");
